...
import com.example.gcashtestjweatherapp.databinding.WeatherItemBinding
import com.example.gcashtestjweatherapp.model.WeatherForecast


class WeatherForecastAdapter(private val clickListener: ForecastOnClickListener) : ListAdapter<WeatherForecast, WeatherForecastAdapter.ViewHolder>(
