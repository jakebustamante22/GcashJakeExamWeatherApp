package com.example.gcashtestjweatherapp.ui.login
...
import com.example.gcashtestjweatherapp.database.RegisterDatabase
import com.example.gcashtestjweatherapp.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    private fun displayUsersList() {
        Log.i("MYTAG","display registration")
